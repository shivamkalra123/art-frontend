  ...
  return (
    <div>
      <div className="hero relative w-screen">
        <img src="public\frontend-images\hero2.jpg" className="w-screen" />
      ...
      <div className="container justify-between align-middle flex mt-20 m-auto">
        <div className="card relative overflow-hidden flex-column justify-between align-middle w-[500px] mx-10">
          <Link>
            <div className="image">
              <img src="public\frontend-images\1.jpg" className=" w-[500px]" />
            </div>
        ...
        <div className="card relative overflow-hidden flex-column justify-between align-middle w-[500px] mx-10">
          <div className="image">
            <img src="public\frontend-images\2.jpg" className=" w-[500px]" />
          </div>
          <div className="title text-2xl font-thin text-center left-10 right-10 bottom-10 p-3 absolute bg-white">
            <Link>Title</Link>
          </div>
        ...
        <div className="card relative overflow-hidden  flex-column justify-between align-middle w-[500px] mx-10 ">
          <div className="image">
            <img src="public\frontend-images\3.jpg" className=" w-[500px]" />
          </div>
          <div className="title text-2xl font-thin text-center left-10 right-10 bottom-10 p-3 absolute bg-white">
            <Link>Title</Link>
          </div>
      ...
      <div className="intro relative overflow-hidden flex justify-center align-middle w-screen my-20 mx-10 ">
        <div className="image">
          <img src="public\frontend-images\intro.jpg" className=" w-[700px]" />
        </div>
      ...
      <div className="Link border-2 border-black w-60 text-center py-3 m-auto my-20">
        View More
      </div>
